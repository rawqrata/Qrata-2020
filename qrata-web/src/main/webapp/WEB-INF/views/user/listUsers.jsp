...
<body>
	...
	<div class="center-table">
		<form:form cssClass="form-search" commandName="userForm" action="listUsers.htm" autocomplete="off">
			<div class="input-append">
				<form:input path="userSearchVal" cssClass="span2 search-query" placeholder="Enter First Name or Last Name or Login or Email" 
					id="userSearch" cssStyle="width: 310px;" />
		...
		<div
			...
			<span><a id="create-user" href="${ctx}/admin/addUser.htm">Add
					User<img style="padding-left: 4px;"
					src="${ctx }/resources/images/plus-sign.png">
			</a></span>
		</div>
		
		<display:table id="userList" name="${users}" pagesize="10" class="displayTable" style="margin-bottom:1%;margin-top:1%;" 
