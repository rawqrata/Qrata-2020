...
<div class="col-md-8 col-8">
    ...
    <display:table id="editor" name="${editors}" pagesize="10" class="displayTable table table-striped table-hover table-bordered table-condensed" style="margin-bottom:1%;margin-top:1%;" requestURI="listEditors.htm"
    	...
    	<a href="${ctx}/admin/allExperts_Editors.htm?id=<c:out value='${editor.id }'/>"><i class="fa fa-eye"></i></a>
    	</display:column>
    </display:table>
    </div>
