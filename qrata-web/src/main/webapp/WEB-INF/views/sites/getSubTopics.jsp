...
<div class="col-md-12">
	...
	<div class="topicbox">
		...
		<display:table id="subTopic" name="${topicList}" pagesize="10" class="displayTable table table-striped table-hover table-bordered table-condensed"
			style="margin-bottom:1%;margin-top:1%;" requestURI="getSubTopics.htm" defaultsort="1" sort="external" defaultorder="descending" partialList="true" size="${totalSubActiveTopics}">
			
			<display:column title="Sub Topics" style="width: 540px;" sortable="true" sortName="name" >
			...
			<display:column title="Criteria">
				<a href="${ctx}/admin/findContentsByTopic.htm?id=${subTopic.topicId}"> ${subTopic.count} Content Ratings</a>
			</display:column>
		</display:table>
