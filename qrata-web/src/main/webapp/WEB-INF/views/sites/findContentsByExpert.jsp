...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			autoCompleter.commonAutocomplete($("#contxt").val()+"/admin/autoSuggestReviewsBySiteName.htm", "reviewSearch", "RATINGSBYEXPERT", "${user.id}");
		});
	</script>
</head>
<body>
	...
	<div class="sitebox">
		...
		<display:table id="siteReview" name="${siteReviewList}" pagesize="10" class="displayTable table table-striped table-hover table-bordered table-condensed"
			style="margin-bottom:1%;margin-top:1%;" defaultsort="1" sort="external" defaultorder="descending" requestURI="findContentsByExpert.htm" partialList="true" size="${totalRatings}">
			...
			<display:column title="Preview">
				<a href="${ctx}/admin/siteCriteriaRatings.htm?siteId=${siteReview.siteId}&topicId=${siteReview.topicId}&sitereviewId=${siteReview.siteId}&view=11&preview=1&type=ex"><i class="icon-eye-open"></i></a>
			</display:column>
		</display:table>
