   ...
   <body>
            ...
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-md-2 col-lg-1 col-3 text-right  pt-2">
                     <a class="logout-button" href="<c:url value="/j_spring_security_logout"/>"> <i class="fa fa-sign-out-alt"></i> Logout</a>
                  </div>
               </div>
            </div>
         </nav>
      ...
      <div class="container">
         <div class="row">
            <div class="col-md-3">
               <!--menu bar left-->
               <div class="left-section" style="margin-top: 37px;width: 100%;font-size:12px;">
                  <div class="home-menu"><a href="../welcome.htm"><i class="fa fa-home"></i> Home</a></div>
                  <div id="accordion">
