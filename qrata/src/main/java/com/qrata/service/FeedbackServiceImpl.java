...
import com.qrata.utility.MailUtility;
...
public class FeedbackServiceImpl implements FeedbackService {
	...
	@Override
	public boolean sendFeedbackEmail(String subject, String heading, String zipcode, String name, String from,
			String content) {
		content = "Hi Admin,\n\n\nName\t\t:\t" + name + "\n\nEmail\t\t:\t" + from + "\n\nZip-code\t:\t" + zipcode
				+ "\n\n" + heading + "\t:\t" + content + "\n\nThanks. \n";
	...
	@Override
	public boolean sendFeedbackCashContent(String name, String zipcode, String from, String topic, String site,
			String url) {
