...
<body>
    ...
    <form:form cssClass="form-search" modelAttribute="categoryForm" action="allSubCategories.htm" autocomplete="off">
        <div class="input-append" style="padding-top: 12px; padding-left: 10px;">
            <form:input path="domainSearchVal" cssClass="span2 search-query" placeholder="Enter sub category name"
                        id="subCategorySearch" cssStyle="width: 260px;" />
	...
	<div class="center-table">
		...
		<display:table id="subCategory" name="${subCategoryList}" pagesize="10" class="displayTable table table-striped table-hover table-bordered table-condensed" 
			...
			<display:column title="Sub Category Name" style="width: 540px;" sortable="true" sortName="name">
				...
				<p>
<%-- 					<b><a onclick="showAccordianAndActiveLink(0, 'domainsLink')" href="listDomains.htm">Root:</a></b>&#47;&#47;&nbsp;<b:breadcrumb separator="&nbsp;&#62;&#62;&nbsp;" serialId="${subCategory.parentCategory.id}" type="CATEGORY" />
 --%>				</p>
			</display:column>
