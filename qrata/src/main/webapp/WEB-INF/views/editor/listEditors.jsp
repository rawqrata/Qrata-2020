...
<body>
    ...
    <form:form cssClass="form-search" modelAttribute="userForm" action="listEditors.htm" autocomplete="off">
        <div class="input-append" style="padding-top: 12px; padding-left: 10px;">
            <form:input path="userSearchVal" cssClass="span2 search-query" placeholder="Enter First Name or Last Name or Login or Email"
                        id="editorSearch" cssStyle="width: 260px;" />
    ...
    <display:table id="editor" name="${editors}" pagesize="10" class="displayTable" style="margin-bottom:1%;margin-top:1%;" requestURI="listEditors.htm"
    	...
    	<a href="${ctx}/admin/allExpertsForEditor.htm?id=<c:out value='${editor.id }'/>"> View &#62;&#62;</a>
    	</display:column>
    </display:table>
