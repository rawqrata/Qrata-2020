        ...
        <div class="col-md-offset-1 col-md-10 gray">
            ...
            <table width="100%" style="text-align: left;">
                ...
                <tbody>
                    ...
                    <c:forEach var="parentCriteria" items="${siteReview.parentCriteriaWithChildren[0]}">

                        <tr>
                            <td style="font-style: italic; background-color: #F5F5F5;" colspan="2"><c:out value="${parentCriteria.key}"></c:out></td>
                            <td style="color: red;font-weight: bold; background-color: #F5F5F5;">
                                <a class="red bold" href="${ctx}/criterias/ratingCriteriaVote.htm?id=${siteReview.id}">Vote Here</a>
                            </td>
                        </tr>
                        ...
                        <c:forEach var="srrc" items="${parentCriteria.value}">
                            ...
                            <c:if test="${srrc.ratingCriteria.parentRatingCriteria.name eq parentCriteria.key}">
                                <tr>
                                    <td>
                                        <a href="${ctx}/criterias/ratingCriteria.htm#${srrc.ratingCriteria.name}">
                                            <c:out value="${srrc.ratingCriteria.name}"></c:out>
                                        </a>
                                    </td>
