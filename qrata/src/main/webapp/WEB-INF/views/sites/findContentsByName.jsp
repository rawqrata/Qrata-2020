...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			autoCompleter.commonAutocomplete($("#contxt").val()+"/admin/autoSuggestReviewsBySiteName.htm", "reviewSearch");
		});
	</script>
</head>
<body>
	...
	<ul class="shape-design">
		...
		<li class="none">Content By Name</li>
	</ul>
	<div class="back-button"><a href="javascript:;" onclick="javascript:historyButton()">&#60;&#60; Go Back </a></div>
	

	<div class="center-table">
		<form:form cssClass="form-search" modelAttribute="siteForm" action="findContentsByName.htm" autocomplete="off">
		...
		<display:table id="siteReview" name="${siteReviewList}" pagesize="10" class="displayTable table table-striped table-hover table-bordered table-condensed"
			style="margin-bottom:1%;margin-top:1%;" defaultsort="1" sort="external" defaultorder="descending" requestURI="findContentsByName.htm" partialList="true" size="${totalRatings}">
			<display:column title="Content" sortable="true" sortName="site.name" style="width: 480px">
				...
				<p><b><a onclick="showAccordianAndActiveLink(0, 'domainsLink')" href="listDomains.htm">Root:</a></b>&#47;&#47;&nbsp;
<%-- 				<b:breadcrumb serialId="${siteReview.siteId}-${siteReview.topicId}" separator="&nbsp;&#62;&#62;&nbsp;" type="SITE"/></p>
 --%>			</display:column>
			...
			<display:column title="Preview">
				<a href="${ctx}/admin/siteCriteriaRatings.htm?siteId=${siteReview.siteId}&topicId=${siteReview.topicId}&sitereviewId=${siteReview.siteId}&view=11&preview=1&type=e"><i class="icon-eye-open"></i></a>
			</display:column>
		</display:table>
