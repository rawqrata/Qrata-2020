...
<body>
	...
	<div class="center-table">
		<form:form cssClass="form-search" modelAttribute="siteForm" action="findNewSiteRatings.htm" autocomplete="off" method="post">
...
<%-- 				<b: serialId="${siteReview.siteId}-${siteReview.topicId}" separator="&nbsp;&#62;&#62;&nbsp;" type="SITE"/></p> --%>
			</display:column>
