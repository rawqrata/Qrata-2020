...
<body>
	...
	<div class="span6 q-nav feedback">
		...
		<form action="${ctx}/feedbackMail.htm" name="new_feedback"
			class="new_feedback" id="new_feedback" method="post" onsubmit="return validate()">
			<div style="margin: 0; padding: 0; display: inline">
				<input name="utf8" type="hidden" value="✓"><input
					name="authenticity_token" type="hidden"
					value="axrndyytbQIB78IMyj75KrRiMGM/nxEP+ljlLrXuSqg=">
			</div>
			...
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<textarea class="span8" cols="40" id="feedback_body"
							name="feedback_body" rows="4"></textarea>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" for="feedback_name">Your Name:</label>
					<div class="controls">
						<input class="span4" id="feedback_name" name="feedback_name"
							size="30" type="text">
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" for="feedback_email">Your
						Email Address:</label>
					<div class="controls">
						<input class="span4" id="feedback_email" name="feedback_email"
							size="30" type="text">
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" for="feedback_zip_code">Zip or
						Postal Code:</label>
					<div class="controls">
						<input class="span4" id="feedback_zip_code"
							name="feedback_zip_code" size="30" type="text">
					</div>
				</div>
				<input id="feedback_kind" name="feedback_kind" type="hidden"
					value="${kind}">
				<div class="submit">
					<input class="btn btn-primary" name="commit" type="submit"
						value="Submit Now!"> <input id="kind" name="kind"
						type="hidden" value="${kind}">
						<input id="heading" name="heading"
						type="hidden" value="${heading}">
				</div>
